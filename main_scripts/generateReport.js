...
async function fetchReportPrices() {
    try {
...
from (           (
    ...
    FROM 
      ...
      where report_drugs.report_id = 147 and drug_master.zip_code = '30062' and price.rank = 0 
      order by name) t
  ...
  union all
    ...
    FROM
      ...
      from report_drugs full outer join price on  price.id = report_drugs.price_id
        full outer join drug_master on price.drug_details_id = drug_master.id
      where report_drugs.report_id = 147 and drug_master.zip_code = '30062' and price.rank = 1
      order by drug_id) t
  ...
  union all
    ...
    FROM
      ...
      from report_drugs full outer join price on  price.id = report_drugs.price_id
        full outer join drug_master on price.drug_details_id = drug_master.id
      where report_drugs.report_id = 147 and drug_master.zip_code = '30062' and price.rank = 2) t
  ...
  union all
    ...
    FROM
      ...
      from report_drugs full outer join price on  price.id = report_drugs.price_id
        full outer join drug_master on price.drug_details_id = drug_master.id
      where report_drugs.report_id = 147 and drug_master.zip_code = '30062' and price.rank = 3) t
  ...
  union all
    ...
    FROM
      ...
      from report_drugs full outer join price on  price.id = report_drugs.price_id
        full outer join drug_master on price.drug_details_id = drug_master.id
      where report_drugs.report_id = 147 and drug_master.zip_code = '30062' and price.rank = 4) t
    GROUP BY t.name , t.dosage_strength,t.drug_id, t.quantity, t.ndc, t.gsn, t.recommended_price, t.unc_price, t.zip_code,t.rank
